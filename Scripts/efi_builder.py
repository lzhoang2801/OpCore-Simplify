...
class builder:
    ...
    def build_efi(self, hardware, unsupported_devices, smbios_model, macos_version, acpi_guru):
        ...
        efi_option["Custom CPU Name"] = not (" Core" in hardware_shorc.get("Processor Name") and self.utils.contains_any(cpu_data.IntelCPUGenerations, hardware_shorc.get("CPU Codename"), start=3))
