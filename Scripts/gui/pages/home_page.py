...
class HomePage(ScrollArea):
    ...
    def _create_hero_section(self):
        ...
        robot_icon = build_icon_label(FluentIcon.ROBOT, COLORS['primary'], size=64)
    ...
    def _create_note_card(self):
        ...
        note_icon = build_icon_label(FluentIcon.INFO, COLORS['note_text'], size=40)
    ...
    def _create_guide_row(self, icon, title, desc):
        ...
        row_icon = build_icon_label(icon, COLORS['primary'], size=24)
