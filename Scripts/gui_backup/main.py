...
from qfluentwidgets import FluentWindow, NavigationItemPosition, FluentIcon, setTheme, Theme, isDarkTheme
from qfluentwidgets import InfoBar, InfoBarPosition

from .styles import COLORS, SPACING
from .widgets import ConsoleRedirector
...
class OpCoreGUI(FluentWindow):
    ...
    def __init__(self, ocpe_instance):
        ...
        # Variables for tracking state (using plain Python variables instead of StringVar)
