...
kexts = [
    KextInfo(
        ...
        category="Required",
        required=True,
        github_repo={"owner": "acidanthera", "repo": "Lilu"},
    ),
    KextInfo(
        name="VirtualSMC",
        ...
        required=True,
        requires_kexts=["Lilu"],
        github_repo={"owner": "acidanthera", "repo": "VirtualSMC"},
    ),
    KextInfo(
    ...
    KextInfo(
        ...
        requires_kexts=["Lilu", "VirtualSMC"],
        github_repo={"owner": "ChefKissInc", "repo": "SMCRadeonSensors"},
        download_info={
    ...
    KextInfo(
        ...
        github_repo={"owner": "ChefKissInc", "repo": "NootRX"},
        download_info={
            "id": int("".join(random.choices("0123456789", k=9))),
    ...
    KextInfo(
        ...
        requires_kexts=["Lilu"],
        conflict_group_id="GPU",
        github_repo={"owner": "ChefKissInc", "repo": "NootedRed"},
        download_info={
            "id": int("".join(random.choices("0123456789", k=9))),
    ...
    KextInfo(
        ...
        requires_kexts=["Lilu"],
        conflict_group_id="GPU",
        github_repo={"owner": "acidanthera", "repo": "WhateverGreen"},
    ),
    KextInfo(
        name="AppleALC",
        ...
        category="Audio",
        requires_kexts=["Lilu"],
        github_repo={"owner": "acidanthera", "repo": "AppleALC"},
    ),
    KextInfo(
        ...
        category="Wi-Fi",
        requires_kexts=["Lilu"],
        github_repo={"owner": "acidanthera", "repo": "AirportBrcmFixup"},
    ),
    KextInfo(
        name="AirportItlwm",
    ...
    KextInfo(
        ...
        github_repo={"owner": "zxystd", "repo": "AthBluetoothFirmware"},
    ),
    KextInfo(
    ...
    KextInfo(
        ...
        requires_kexts=["Lilu"],
        github_repo={"owner": "acidanthera", "repo": "BrcmPatchRAM"},
    ),
    KextInfo(
    ...
    KextInfo(
        ...
        github_repo={"owner": "OpenIntelWireless", "repo": "IntelBluetoothFirmware"},
    ),
    KextInfo(
        name="IntelBTPatcher",
    ...
    KextInfo(
        ...
        category="Ethernet",
        github_repo={"owner": "donatengit", "repo": "AppleIGB"},
        download_info={
            "id": 736194363,
    ...
    KextInfo(
        ...
        category="Ethernet",
        github_repo={"owner": "SongXiaoXi", "repo": "AppleIGC"},
    ),
    KextInfo(
        name="AtherosE2200Ethernet",
        description="Provides support for Atheros E2200 family",
        category="Ethernet",
        github_repo={"owner": "Mieze", "repo": "AtherosE2200Ethernet"},
    ),
    KextInfo(
    ...
    KextInfo(
        ...
        category="Ethernet",
        github_repo={"owner": "TomHeaven", "repo": "HoRNDIS"},
        download_info={"id": 79378595, "url": "https://github.com/TomHeaven/HoRNDIS/releases/download/rel9.3_2/Release.zip"},
    ),
    KextInfo(
        name="IntelLucy",
        description="Provides support for Intel X500 family",
        category="Ethernet",
        github_repo={"owner": "Mieze", "repo": "IntelLucy"},
    ),
    KextInfo(
        name="IntelMausiEthernet",
        description="Intel Ethernet LAN driver for macOS",
        category="Ethernet",
        github_repo={"owner": "Mieze", "repo": "IntelMausiEthernet"},
    ),
    KextInfo(
        name="LucyRTL8125Ethernet",
        description="Provides support for Realtek RTL8125 family",
        category="Ethernet",
        github_repo={"owner": "Mieze", "repo": "LucyRTL8125Ethernet"},
    ),
    KextInfo(
        name="NullEthernet",
        description="Creates a Null Ethernet when no supported network hardware is present",
        category="Ethernet",
        github_repo={"owner": "RehabMan", "repo": "os-x-null-ethernet"},
        download_info={"id": 182736492, "url": "https://bitbucket.org/RehabMan/os-x-null-ethernet/downloads/RehabMan-NullEthernet-2016-1220.zip"},
    ),
    KextInfo(
        name="RealtekRTL8100",
        description="Provides support for Realtek RTL8100 family",
        category="Ethernet",
        github_repo={"owner": "Mieze", "repo": "RealtekRTL8100"},
        download_info={
            "id": 10460478,
    ...
    KextInfo(
        ...
        category="Ethernet",
        github_repo={"owner": "Mieze", "repo": "RTL8111_driver_for_OS_X"},
        download_info={"id": 130015132, "url": "https://github.com/Mieze/RTL8111_driver_for_OS_X/releases/download/2.4.2/RealtekRTL8111-V2.4.2.zip"},
    ),
    KextInfo(
        name="GenericUSBXHCI",
        description="Fixes USB 3.0 issues found on some Ryzen APU-based",
        category="USB",
        github_repo={"owner": "RattletraPM", "repo": "GUX-RyzenXHCIFix"},
    ),
    KextInfo(name="USBToolBox", description="Flexible USB mapping", category="USB", github_repo={"owner": "USBToolBox", "repo": "kext"}),
    KextInfo(
        name="UTBDefault",
        description="Enables all USB ports (assumes no port limit)",
        category="USB",
        requires_kexts=["USBToolBox"],
        github_repo={"owner": "USBToolBox", "repo": "kext"},
    ),
    KextInfo(
        name="XHCI-unsupported",
        description="Enables USB 3.0 support for unsupported xHCI controllers",
        category="USB",
        github_repo={"owner": "daliansky", "repo": "OS-X-USB-Inject-All"},
        download_info={"id": 185465401, "url": "https://github.com/daliansky/OS-X-USB-Inject-All/releases/download/v0.8.0/XHCI-unsupported.kext.zip"},
    ),
    KextInfo(
        name="AlpsHID",
    ...
    KextInfo(
        ...
        category="Input",
        min_darwin_version="18.0.0",
        github_repo={"owner": "VoodooSMBus", "repo": "VoodooSMBus"},
    ),
    KextInfo(
        name="VoodooI2C",
        description="Intel I2C controller and slave device drivers",
        category="Input",
        github_repo={"owner": "VoodooI2C", "repo": "VoodooI2C"},
    ),
    KextInfo(
    ...
    KextInfo(
        ...
        requires_kexts=["Lilu"],
        github_repo={"owner": "hieplpvip", "repo": "AsusSMC"},
    ),
    KextInfo(
        name="BigSurface",
        ...
        category="Brand Specific",
        requires_kexts=["Lilu"],
        github_repo={"owner": "Xiashangning", "repo": "BigSurface"},
    ),
    KextInfo(
        name="YogaSMC",
        ...
        category="Brand Specific",
        requires_kexts=["Lilu", "VirtualSMC"],
        github_repo={"owner": "zhen-zen", "repo": "YogaSMC"},
    ),
    KextInfo(
        name="CtlnaAHCIPort",
    ...
    KextInfo(
        ...
        min_darwin_version="18.0.0",
        requires_kexts=["Lilu"],
        github_repo={"owner": "acidanthera", "repo": "NVMeFix"},
    ),
    KextInfo(
        ...
        github_repo={"owner": "0xFireWolf", "repo": "RealtekCardReader"},
    ),
    KextInfo(
        ...
        github_repo={"owner": "0xFireWolf", "repo": "RealtekCardReaderFriend"},
    ),
    KextInfo(
        name="Sinetek-rtsx",
        ...
        category="Card Reader",
        conflict_group_id="RealtekCardReader",
        github_repo={"owner": "cholonam", "repo": "Sinetek-rtsx"},
    ),
    KextInfo(
        name="AmdTscSync",
        ...
        github_repo={"owner": "naveenkrdy", "repo": "AmdTscSync"},
    ),
    KextInfo(
        name="VoodooTSCSync",
        ...
        category="TSC Synchronization",
        conflict_group_id="TSC",
        github_repo={"owner": "RehabMan", "repo": "VoodooTSCSync"},
        download_info={
            "id": 823728912,
    ...
    KextInfo(
        ...
        requires_kexts=["Lilu"],
        conflict_group_id="TSC",
        github_repo={"owner": "acidanthera", "repo": "CpuTscSync"},
    ),
    KextInfo(
        ...
        requires_kexts=["Lilu"],
        conflict_group_id="TSC",
        github_repo={"owner": "ChefKissInc", "repo": "ForgedInvariant"},
        download_info={
            "id": int("".join(random.choices("0123456789", k=9))),
    ...
    KextInfo(
        ...
        category="Extras",
        download_info={"id": 738162736, "url": "https://github.com/acidanthera/bugtracker/files/3703498/AppleMCEReporterDisabler.kext.zip"},
    ),
    KextInfo(
        name="BrightnessKeys",
        ...
        category="Extras",
        requires_kexts=["Lilu"],
        github_repo={"owner": "acidanthera", "repo": "BrightnessKeys"},
    ),
    KextInfo(
        name="CPUFriend",
        ...
        category="Extras",
        requires_kexts=["Lilu"],
        github_repo={"owner": "acidanthera", "repo": "CPUFriend"},
    ),
    KextInfo(
        ...
        category="Extras",
        requires_kexts=["Lilu"],
        github_repo={"owner": "b00t0x", "repo": "CpuTopologyRebuild"},
    ),
    KextInfo(
        name="CryptexFixup",
        ...
        min_darwin_version="22.0.0",
        requires_kexts=["Lilu"],
        github_repo={"owner": "acidanthera", "repo": "CryptexFixup"},
    ),
    KextInfo(
        name="ECEnabler",
        ...
        category="Extras",
        requires_kexts=["Lilu"],
        github_repo={"owner": "1Revenger1", "repo": "ECEnabler"},
    ),
    KextInfo(
        name="FeatureUnlock",
        ...
        category="Extras",
        requires_kexts=["Lilu"],
        github_repo={"owner": "acidanthera", "repo": "FeatureUnlock"},
    ),
    KextInfo(
        ...
        category="Extras",
        requires_kexts=["Lilu"],
        github_repo={"owner": "acidanthera", "repo": "HibernationFixup"},
    ),
    KextInfo(
        name="NoTouchID",
        ...
        requires_kexts=["Lilu"],
        github_repo={"owner": "al3xtjames", "repo": "NoTouchID"},
    ),
    KextInfo(
        name="RestrictEvents",
        ...
        category="Extras",
        requires_kexts=["Lilu"],
        github_repo={"owner": "acidanthera", "repo": "RestrictEvents"},
    ),
    KextInfo(
        name="RTCMemoryFixup",
        ...
        category="Extras",
        requires_kexts=["Lilu"],
        github_repo={"owner": "acidanthera", "repo": "RTCMemoryFixup"},
    ),
]
