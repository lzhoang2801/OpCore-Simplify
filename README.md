...
<p>-it uses an outdated user agent of Google Chrome - Google Chrome 131. This opens also all vulnerabilities that Google has patched in newer versions of Chrome. And this opens also a vulnerability where websites redirect to outdated servers which can lead to even more vulnerabilities. CVSS v3.1 Base Score: 6.6. This exploit is mitigated by changing the user agent to the latest version of Safari - Safari 26.1. This also improves download speeds a little bit.</p>
